...
def test_root():
    res = open("tests/unit/test_response/root_response.txt",
               "r").read().strip()
    response = client.get("/")
...
def test_description():
    res = open("tests/unit/test_response/video_description.txt",
               "r").read().strip()
...
def test_video_details():
    res = open("tests/unit/test_response/video_details.txt",
               "r").read().strip()
...
def test_comments_sentiments():
    res = open("tests/unit/test_response/comment_sentiments.txt",
               "r").read().strip()
